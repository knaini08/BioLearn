...
struct CellularRespirationView: View {
                    ...
                    VStack {
                        ...
                        NavigationLink {
                            ...
                            RoundedRectangle(cornerRadius: 10)
                                ...
                                .overlay(
                                    VStack {
                                        Text("10.1 Cellular Respiration")
                                            .foregroundStyle(.black)
                                            .font(Font.custom("Impact", size: 20))
